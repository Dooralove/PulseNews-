# Generated by Django 5.2.7 on 2025-10-21 23:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('reader', 'Читатель'), ('editor', 'Редактор'), ('admin', 'Администратор')], max_length=50, unique=True, verbose_name='Название роли')),
                ('display_name', models.CharField(max_length=100, verbose_name='Отображаемое название')),
                ('description', models.TextField(blank=True, verbose_name='Описание')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Дата обновления')),
                ('permissions', models.ManyToManyField(blank=True, related_name='custom_roles', to='auth.permission', verbose_name='Права доступа')),
            ],
            options={
                'verbose_name': 'Роль',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('login', 'Вход'), ('logout', 'Выход'), ('register', 'Регистрация'), ('password_change', 'Смена пароля'), ('password_reset', 'Сброс пароля'), ('profile_update', 'Обновление профиля'), ('article_create', 'Создание статьи'), ('article_update', 'Обновление статьи'), ('article_delete', 'Удаление статьи'), ('comment_create', 'Создание комментария'), ('comment_delete', 'Удаление комментария')], max_length=50, verbose_name='Действие')),
